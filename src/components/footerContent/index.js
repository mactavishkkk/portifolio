        ...
        <Fragment>
            ...
            <section>
                <div className="container">
                    <div className="2xl:mx-[0px] xl:mx-[0px] md:mx-[-120px] sm:mx-[-150px] flex justify-center" data-aos="flip-left" data-aos-duration="1000">
            ...
            <footer className="bg-black mt-90 h-80">
