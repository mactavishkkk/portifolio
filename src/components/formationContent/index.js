        ...
        <Fragment>
            ...
            <section>
                <div className="container">
                    <div className="flex justify-center mb-32 2xl:mb-32 xl:mb-32 lg:mb-3 md:mb-3" id="formation" data-aos="fade-up" data-aos-duration="1000">
                        <img className="w-96" src="/img/title-formation.png" alt="Titulo da seção de formação, representado por um pergaminho" />
                    </div>
                    <div className="2xl:mx-[0px] xl:mx-[0px] md:mx-[-120px] sm:mx-[-150px] text-right font-mono ... subpixel-antialiased ... shadow-lg" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="200">
                    ...
                    <div className="2xl:mx-[0px] xl:mx-[0px] md:mx-[-120px] sm:mx-[-150px] mt-14 text-right font-mono ... subpixel-antialiased ... shadow-lg" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="300">
                    ...
                    <div className="2xl:mx-[0px] xl:mx-[0px] md:mx-[-120px] sm:mx-[-150px] mt-12 text-right font-mono ... subpixel-antialiased ... shadow-lg" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="400">
